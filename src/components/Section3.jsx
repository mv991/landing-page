...
export const Section3 = () => {
    ...
    return (<><div className="lg:w-full w-[97%] mx-auto h-fit flex flex-col">
        <div className="w-full h-fit relative">
             <Image src={mainImg} height={1200} width={1200} alt="img" className="w-full h-auto max-h-[600px] object-cover lg:rounded-xl rounded-md cursor-pointer" onClick={() => {setOpen(true); document.body.style.overflow = "hidden"}}/>  
